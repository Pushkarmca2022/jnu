...
def report_dashboard_view(request):
    return render(request, 'hospital/report_dashboard.html')
...
def discharge_patient_view(request,pk):
    ...
    if request.method == 'POST':
        ...
        pDD.Medicine=request.POST['name']
        print(request.POST['name'])
...
def opd_view(request):
	return render(request, 'hospital/opd.html')
	
def clinictime_view(request):
	return render(request, 'hospital/clinictime.html')
